...
(
    ...
    receipt_created_date     datetime     NOT NULL,
    receipt_delivery_address varchar(255) NOT NULL,
    receipt_delivery_phone   varchar(255) NOT NULL,
    receipt_delivery_note    varchar(255) NOT NULL,
    receipt_payment_method   varchar(255) NOT NULL,
    receipt_delivery_status  varchar(255) NOT NULL,
    receipt_payment_status   varchar(255) NOT NULL,
    receipt_total_price      int(11)      NOT NULL,
    receipt_total_quantity   int(11)      NOT NULL,
    receipt_cart_id          int(11)      NOT NULL,
